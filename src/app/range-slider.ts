...
const defaultOptions:IOptions = {
 ...
 class RangeSlider extends HTMLElement {
  ...
  ${(this.options.tooltip) ? '<tooltip></tooltip>' : ''}
  </div>
  ...
  (this.querySelector('.track') as HTMLElement).style.cssText = `
  ...
  this.thumbLeft = (this.querySelector('.slider > .thumb.left') as HTMLElement);
  this.thumbRight = (this.querySelector('.slider > .thumb.right') as HTMLElement);
  this.range = (this.querySelector('.slider > .range') as HTMLElement);
  this.tooltips = this.querySelectorAll('tooltip');
